...
export default function Archive(){
        ...
        const readyproject = Data_Project_.filter(project => project.activepin === 'completed')
        function countproject() {
           const countProjectData =  Data_Project_.length;
    ...
    return(
        ...
        <div className="container_content_of_page">
            ...
            <div className="input_search">
                ...
                <MainInput
                placeholder='Поиск проекта' newinput='newinput' icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
