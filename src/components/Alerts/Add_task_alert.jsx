...
export default function AddTaskAlert({closedAddtask,safetaskinlist}){
    ...
    const items = [
        {
           key: 'choosestuff_1',
           label: 'Иван Иванов',
           onClick: () => setSelectedEmployee('Иван Иванов')
       },
       {
           key: 'choosestuff_2',
           label: 'Петр Петров',
           onClick: () => setSelectedEmployee('Петр Петров')
       },
       {
           key: 'choosestuff_3',
    ...
    const project_button = [
        {
           key: 'chooseproject_1',
           label: 'Сделать wireframe',
           onClick: () => setSelectedProject('Сделать wireframe')
       },
       {
           key: 'chooseproject_2',
           label: 'Разработка API',
           onClick: () => setSelectedProject('Разработка API')
       },
       {
           key: 'chooseproject_3',
           label: 'Тестирование',
           onClick: () => setSelectedProject('Тестирование')
       }
    ];
            ...
            <div className="Addtaskalert">
                ...
                <div className="backgroundtask_white background_shadowdd">
                    ...
                    <div className="inputs_">
                        ...
                        />
                        <Button onClick={openFileDialog} className="button_downloadddddd">Файл 
                            <span>
